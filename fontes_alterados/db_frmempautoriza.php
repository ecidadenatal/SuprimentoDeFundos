    ...
    <td>
      <?
          ...
          if ($clcflicita->numrows > 0) {
             ...
             */
            db_selectrecord("e54_tipol",$result,true,isset($emprocesso)&&$emprocesso==true?"1":"1", "","","", "", "js_verificaLicitacao()");
            $dop = $db_opcao;
          } else {
            ...
            $e54_numerl = '';
            $dop        = '3';
            db_input('e54_tipol',8,$Ie54_tipol,true,'text',3, "onchange='js_verificaLicitacao(); js_reload(this.value);'");
          }
      ?>
  ...
  <tr>
    ...
    <td>
      ...
      //desabilitar o campo para alteração
        ...
        */
        $result = $clpctipocompra->sql_record($clpctipocompra->sql_query_file(null,"pc50_codcom as e54_codcom,pc50_descr", null, "pc50_codcom in (select l03_codcom from cflicita where l03_tipo = '{$e54_tipol}')"));
        db_selectrecord("e54_codcom",$result,true,isset($emprocesso)&&$emprocesso==true?"1":$db_opcao,"","","","","");
      ?>
    </td>
  </tr>
...
function js_verificaLicitacao() {

  if (document.form1.e54_tipol.value == "D") {
    document.form1.e54_codcom.disabled      = true;
    document.form1.e54_codcomdescr.disabled = true;
    return;
  }
  document.form1.e54_codcom.disabled      = false;
  document.form1.e54_codcomdescr.disabled = false;
}
