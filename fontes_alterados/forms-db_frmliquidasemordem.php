        ...
        <tr>
          ...
          <td>
            ...
            <script>
              ...
              <!--[Extensao LiquidacaoCompetencia] inclusao do campo -->
          <? 
           if ($operacao == 1) {
             echo "<tr>
                     <td> 
...
var nValorCotas = 0;
  ...
  function js_saida(oAjax) {
    ...
    /* [Inicio plugin suspensaoOrcamentaria - Parte1] */
    ...
    /* [Fim plugin suspensaoOrcamentaria - Parte1] */
    ...
    if (obj.numnotas > 0){
      ...
      for (i = 0; i < obj.data.length;i++){
        ...
        /* Plugin [LiquidacaoQuantidadeValor] - Parte 1 */        var sServicoQuant = obj.data[i].servicoquantidade == "t" ? "true" : "false";
    ...
    new AjaxRequest("emp4_empenhocotasmensais.RPC.php", oRequestCotas, function(oResponse, lError) {
      ...
      if (lValidaCotas) {
        ...
        oResponse.cotas.each(function(oCota) {
          ...
          if (oCota.mes <= +oResponse.mes_usu) {
      ...
      nValorCotas = nValorCotas < 0 ? 0 : nValorCotas.toFixed(2);
  ...
  /* Plugin [LiquidacaoQuantidadeValor] - Parte 2 */  function js_verificaQuantidade(sequenItem, ServicoQuantidade, Servico){
  ...
  function js_liquidar(metodo) {
    ...
    if (lValidaCotas && valorTotal > nValorCotas) {
